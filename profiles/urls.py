...
urlpatterns = [
    ...
    url(r'^followed-activity/$', views.FeedView.as_view(), name='followed_activity'),
    url(r'^profile-activity/$', views.ActivityView.as_view(), name='profile_activity'),
    url(r'^suggested/$', views.ProfileSuggestedView.as_view(), name='suggested'),
